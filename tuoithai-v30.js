...
Date.prototype.format = function () {
  ...
  function calHeader() {
	...
	txtOut += Math.floor(v_days/7) + "w" + (v_days - Math.floor(v_days/7)*7) + ": " + v_curdate.format();
  ...
  function calToAge_click() {
    if (gInput.valid1 == false) {
      ...
      if (gInput.valid2 == false) {
        ...
        */
        var txtOut = Math.floor(v_days/7) + "w" + (v_days - Math.floor(v_days/7)*7) + "d";
        mylog(txtOut + ": " + gInput.date2.format());
      }
    }
  }
  ...
  function calToDate_click() {
    if (gInput.valid1 == false) {
      ...
      */
      var txtOut = Math.floor(gInput.day2/7) + "w" + (gInput.day2 - Math.floor(gInput.day2/7)*7) + "d";
      mylog(txtOut + ": " + v_date.format());
    }
  }
